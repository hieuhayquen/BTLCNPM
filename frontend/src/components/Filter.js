    ...
    return (
        <div className={`filterarea ${classac}`}>
            ...
            <div className="colorsdiv">
                <h1> Color</h1>
                <div className="col" style={{ backgroundColor: 'black' }}></div>BLACK
                <br />
                <div className="col" style={{ backgroundColor: 'white' }}></div>WHITE
                <br />
                <div className="col" style={{ backgroundColor: 'red' }}></div>RED
                <br />
                <div className="col" style={{ backgroundColor: 'blue' }}></div>BLUE
                <br />
                <div className="col" style={{ backgroundColor: 'grey' }}></div>GRY
                <br />
            </div>
        </div>
    );
