        ...
        <>
            <div className="Cgfilter">
                ...
                <div className="filtersbtn ">
                    <button className={`filterbtn ${showfilter ? 'activebtn' : ''}`} onClick={filterfunc}>
                        {' '}
            ...
            <div className={`filterarea ${showfilter ? 'filter' : 'filteroff'}`}>
                <div className="sortbydiv">
                    <h1> Sort By</h1>
                    <ul>
                        <Link onClick={() => setshowfilter(false)} className="lined" to="?filter">
                            Default
                        </Link>
                        <Link onClick={() => setshowfilter(false)} className="lined" to="?filter=Rating">
                            Rating
                        </Link>
                        <Link onClick={() => setshowfilter(false)} className="lined" to="?filter=date">
                            Date
                        </Link>
                        <Link onClick={() => setshowfilter(false)} className="lined" to="?filter=highprice">
                            Low to high price
                        </Link>
                        <Link onClick={() => setshowfilter(false)} className="lined" to="?filter=lowprice">
                            high to low price
                        </Link>
                    </ul>
                </div>
