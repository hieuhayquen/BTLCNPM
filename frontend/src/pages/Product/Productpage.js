                            ...
                            <div className="product-content">
                                ...
                                <div className="product-price">
                                    <p className="last-price">
                                        Old Price: <span>${product.price + product.price * 0.5}</span>
                                    </p>
                                ...
                                <div className="product-detail">
                                    ...
                                    <ul>
                                        <li>
                                            Status:{' '}
                                            <span>{product.countInStock > 0 ? 'ìn stock' : 'Out Of Stock'}</span>
                                        </li>
                                        <li>
                                            Category: <span>{product.category.map((cg) => ' | ' + cg + ' | ')}</span>
                                        </li>
                                        <li>
